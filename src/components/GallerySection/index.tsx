  ...
  return (
    <div className="lg:mt-[110px] sm:mt-[60px] mt-[78px] w-full mx-auto">
      ...
      <p className="font-inter text-text lg:max-w-[614px] max-w-[562px] lg:mt-[28px] sm:mt-[18px] mt-[12px] font-normal leading-[30px] text-center mx-auto">
        From bean to brew, discover the story behind our premium coffee. Browse
        our gallery and see how we bring the world’s best flavors to your cup
      </p>
      <div className="lg:mt-[70px] sm:mt-[50px] mt-[40px] grid lg:grid-cols-4 sm:grid-cols-3 grid-cols-2 lg:gap-[32px] gap-[16px] max-lg:px-[24px] max-sm:px-[29px]">
        {items.map(({ image, top }, index) => (
          <img
            ...
            alt="gallery"
            className={clsx(
              "rounded-[12px] aspect-square object-cover w-full h-full relative",
              {
                "lg:top-[40px]": top === 40,
                "lg:top-[80px]": top === 80,
              },
