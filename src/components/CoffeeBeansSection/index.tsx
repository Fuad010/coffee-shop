  ...
  return (
    <section>
      <div className="max-lg:px-[16px]">
        <div
          className="w-full lg:h-[600px] lg:px-[16px] h-max lg:mt-[110px] mt-[60px] flex max-sm:flex-col justify-center items-center bg-no-repeat max-sm:bg-position-[center_bottom] bg-position-[right_top] bg-[length:clamp(100px,100%,700px)] sm:bg-[length:clamp(300px,40%,700px)] lg:bg-[length:clamp(300px,53%,700px)]"
